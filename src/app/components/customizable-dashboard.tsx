                      ...
                      {categoryWidgets.map((widget) => {
                        ...
                        return (
                          <button
                            ...
                            className={`relative p-3 rounded-lg border-2 text-center transition-all hover:scale-105 w-[110px] ${
                              isSelected
                          ...
                          >
                            ...
                            <Icon className={`w-5 h-5 mx-auto mb-1.5 ${isSelected ? 'text-blue-600' : 'text-slate-600'}`} />
                            <span className={`font-medium text-xs block leading-tight ${isSelected ? 'text-blue-900' : 'text-slate-700'}`}>
                              {widget.title}
                            </span>
                            {widget.defaultSize === 'large' && (
                              <span className="text-[10px] text-slate-400 mt-0.5 block">대형</span>
                            )}
                            {widget.defaultSize === 'medium' && (
                              <span className="text-[10px] text-slate-400 mt-0.5 block">중형</span>
                            )}
                          </button>
                        );
                      })}
