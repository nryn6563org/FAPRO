<template>
  <div class="c-widget" :class="{ 'c-widget--editing': isEditing }">
    ...
    <div class="c-widget__content">
        ...
        <!-- 1.1 마켓 티커 -->
        <MarketTickerWidget
          v-else-if="widgetId === 'market-ticker'"
        />
...
// 하위 컴포넌트 임포트
import MarketIndexWidget from './MarketIndexWidget.vue'
import RevenueWidget from './RevenueWidget.vue'
import AIIssueBubbleWidget from './AIIssueBubbleWidget.vue'
import SimpleStatWidget from './SimpleStatWidget.vue'
import KeyClientsWidget from './KeyClientsWidget.vue'
import MarketTickerWidget from './MarketTickerWidget.vue'
import NewsListWidget from './NewsListWidget.vue'
import AIRecommendWidget from './AIRecommendWidget.vue'
import InvestmentInfoWidget from './InvestmentInfoWidget.vue'
...
<style src="@/assets/css/components/organisms/dashboard/widget.css"></style>
